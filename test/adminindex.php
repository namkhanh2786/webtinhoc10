...
<body>
      ...
      <tbody>
            ...
            <tr>
                ...
                <td> <!-- get method -->
                    ...
                    CHỈNH SỬA</a>
                    <a href="deleteBook.php?id=<?php echo $list['id']?>" style="text-decoration: none;"
                        onclick="return confirm('Bạn Muốn Xóa Sách Này?')">XÓA</a>
                </td>
            </tr>
            <?php } ?>
      </tbody>
  ...
  <div class="col-md-12 mt-4 ml-2 container" style="display: flex; justify-content: space-between;">
    <a href="createBook.php" id="createLink"><h4>Thêm Sách Vào Bảng</h4></a>
  </div>
</body>
<script>
